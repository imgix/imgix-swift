...
task :test do
  ...
  sh 'xcodebuild test -project imgix-swift.xcodeproj -scheme ImgixSwift-iOS -destination \'platform=iOS Simulator,name=iPhone 6,OS=latest\' -sdk \'iphonesimulator9.3\' | bundle exec xcpretty --color; exit ${PIPESTATUS[0]}'
end
